...
function HeroCanvas({ mouse }: { mouse: MousePos }) {
  return (
    <Canvas
    ...
    <div className="overflow-hidden w-full select-none" aria-hidden="true">
      ...
      >
        {items.map((item, i) => (
          ...
          >
            <span className="text-muted-foreground font-body">{item.idea}</span>
            <span
...
const FEATURES = [
  {
    ...
    description:
      "Type anything. AI designs the UI, builds the backend, and ships it — while you watch. No code, no waiting.",
    badge: "AI-Powered",
  ...
  },
  {
    ...
    description:
      "The more you build, the smarter it gets. AppVerse predicts your next idea before you've typed a word.",
    badge: "Adaptive",
  ...
  },
  {
    ...
    description:
      "10,000+ creators are building right now. One tap to remix trending ideas and put your name on the map.",
    badge: "Connected",
  ...
  },
  {
    ...
    description:
      "Every app earns XP. Daily challenges, global leaderboards, and real rewards turn creation into your favourite game.",
    badge: "Gamified",
    badgeVariant: "primary" as const,
    glowColor: "oklch(var(--primary)/0.2)",
  },
...
const TESTIMONIALS = [
  {
    ...
    levelLabel: "Builder",
    quote:
      "I described a meditation app at 11pm. By 11:05 I had a full feature set, a color palette, and a monetization plan. I screenshotted everything and sent it to my friends — they could not believe it.",
    initials: "PK",
  ...
  {
    name: "Arjun M.",
    level: "creator" as const,
    levelLabel: "Creator",
    quote:
      "Remixed 3 trending ideas in one afternoon. My concept hit the global top 10 leaderboard before dinner. The community here goes insane when you drop something good.",
    initials: "AM",
  ...
  },
  {
    ...
    levelLabel: "Legend",
    quote:
      "I went from 'I have an idea' to a full app preview in under 2 minutes. I'm not a developer. I'm 19. This thing just handed me a career and I haven't written a single line of code.",
    initials: "ST",
...
const REALITY_POWERS = [
  {
    ...
    description:
      "The app remembers every idea you've touched. Every session, it builds richer, more personalized content tailored to your creative DNA.",
  ...
  },
  {
    ...
    description:
      "Your face becomes your AI avatar. Transform into a Hero, Creator, or Influencer — and build apps from inside that identity.",
  ...
  },
  {
    ...
    description:
      "AI automatically creates trending reels and social clips optimized for each platform. Ready to post — no editing required.",
  ...
  },
  {
    ...
    name: "Emotion AI",
    description:
      "Happy? The app serves fun content. Feeling low? It switches to motivating, uplifting flows. The platform reacts exactly like a human would.",
  ...
  },
  {
    ...
    description:
      "Enter the same digital universe as other creators. Collaborate in real time, co-build ideas, and ship together from anywhere on Earth.",
...
const LIVE_DATA_SOURCES = [
  {
    ...
    title: "Weather APIs",
    description:
      "Live conditions, forecasts, and alerts — auto-wired into every app that needs real-world environmental context.",
  ...
  },
  {
    ...
    title: "Maps & Location",
    description:
      "Real-time GPS, live traffic data, and turn-by-turn directions. Your app knows exactly where its users are.",
  ...
  },
  {
    ...
    description:
      "Doctor availability, fitness wearable sync, and nutrition databases — live data for apps that care about people.",
  ...
  },
  {
    ...
    description:
      "Updated courses, live tutors, and fresh educational content. Your learning apps are always a step ahead.",
...
export default function Landing() {
  ...
  // Mouse tracking for particle parallax
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-x-hidden">
      ...
      <header
        ...
        data-ocid="navbar"
      >
        <div className="container mx-auto h-full flex items-center gap-4 px-4 lg:px-6">
          <Link
            to="/"
          ...
          <nav className="hidden md:flex items-center gap-1 ml-2">
            {(["Features", "Pricing", "Community"] as const).map((label) => (
              <button
                key={label}
                type="button"
          ...
          <Link to="/dashboard" data-ocid="navbar.get_started_button">
            <GlassButton variant="holographic" size="sm" className="gap-1.5">
      ...
      <main className="relative z-10 flex-1">
        ...
        >
          {/* Three.js Canvas with mouse parallax */}
          <motion.div
          ...
          {/* Pulsing portal orb behind hero text */}
          <div
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, oklch(var(--primary)/0.8) 0%, oklch(var(--secondary)/0.4) 50%, transparent 80%)",
              }}
            />
          </div>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 50%, transparent 30%, oklch(var(--background)/0.7) 80%, oklch(var(--background)) 100%)",
            }}
          />
          ...
          >
            ...
            >
              <GlowBadge variant="primary" pulse className="mb-2">
            ...
            >
              Type your idea. AppVerse's AI designs, builds, and launches it —
              while you watch. From thought to product in under 60 seconds.
            </motion.p>

            {/* Core platform promise — Auto-evolving world */}
            <motion.div
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, oklch(0.72 0.22 200 / 0.35), oklch(0.62 0.25 280 / 0.3), oklch(0.72 0.22 262 / 0.35))",
                }}
              ...
              <span
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.72 0.22 200 / 0.12), oklch(0.62 0.25 280 / 0.1), oklch(0.72 0.22 262 / 0.12))",
                  border: "1.5px solid oklch(0.62 0.25 280 / 0.45)",
                  boxShadow:
                    "0 0 24px oklch(0.62 0.25 280 / 0.18), inset 0 1px 0 oklch(1 0 0 / 0.15)",
                }}
              >
                ...
                <motion.span
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, transparent 0%, oklch(0.62 0.25 280 / 0.25) 50%, transparent 100%)",
                ...
                <span
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(90deg, oklch(0.62 0.22 200), oklch(0.58 0.28 280), oklch(0.65 0.24 262))",
                  }}
                >
            ...
            >
              <Link to="/dashboard" data-ocid="landing.cta_primary_button">
                <GlassButton
                  variant="holographic"
                  size="lg"
              ...
              <Link to="/feed" data-ocid="landing.cta_feed_button">
                <GlassButton
                  variant="secondary"
                  size="lg"
            ...
            >
              ...
              <span>⚡ Zero code needed</span>
              <span className="hidden sm:block opacity-30">·</span>
              <span>🎮 Earn XP from day one</span>
            </motion.div>
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(var(--primary)/0.5), oklch(var(--secondary)/0.4), transparent)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(var(--secondary)/0.3), transparent)",
            }}
          />
          <div className="mb-5 text-center px-4">
            ...
            >
              ⚡ Instant transformations happening now
            </motion.p>
          </div>
          <IdeaTicker />
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <GlowBadge variant="secondary" className="mb-4">
                  <Sparkles className="h-3 w-3 mr-1" />
                  Why Creators Choose AppVerse
                </GlowBadge>
                <h2 className="font-display font-bold text-4xl lg:text-6xl mt-4 mb-5 tracking-tight">
                  Four Unfair{" "}
                  <HolographicText
                    as="span"
                    variant="rainbow"
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
                  Every feature was built to make you faster, smarter, and more
                  addicted to creating than ever before.
                </p>
              </motion.div>
            </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-1 text-primary text-sm font-medium mt-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          Explore feature{" "}
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(var(--secondary)/0.5), oklch(var(--accent)/0.4), transparent)",
            }}
          />
          <div
            className="absolute inset-x-0 bottom-0 h-px"
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(var(--primary)/0.3), transparent)",
            }}
          />
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <GlowBadge variant="accent" className="mb-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
                  Five breakthroughs nobody has built into one platform — until
                  now.
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {REALITY_POWERS.map(
                ({ emoji, name, description, borderColor, glowColor }, idx) => (
                  <motion.div
                    key={name}
                    initial={{ opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 80% at 50% 50%, oklch(var(--primary)/0.04) 0%, transparent 70%)",
            }}
          />
          <div className="container mx-auto px-4 lg:px-6 relative z-10">
            ...
            >
              <GlowBadge variant="primary" className="mb-4">
                <Zap className="h-3 w-3 mr-1" />
                Live Universe Stats
              </GlowBadge>
              <h2 className="font-display font-bold text-3xl lg:text-5xl mt-3">
                The Numbers Don't{" "}
                <HolographicText
                  as="span"
                  variant="primary"
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
              {LIVE_STATS.map(
                ({ target, label, suffix, prefix, decimals }, idx) => (
                  <motion.div
                    key={label}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <span
                      ...
                      style={{
                        ...
                        textShadow:
                          "0 0 30px oklch(var(--primary)/0.7), 0 0 60px oklch(var(--primary)/0.3)",
                      }}
                    >
                      <AnimatedCounter
                        target={target}
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              ...
              >
                ...
                <h2 className="font-display font-bold text-4xl lg:text-5xl mt-4 mb-5 tracking-tight">
                  Creators of the{" "}
                  <HolographicText
                    as="span"
                    variant="accent"
                ...
                <p className="text-muted-foreground max-w-xl mx-auto text-base leading-relaxed">
                  Real creators. Real creations. Real magic.
                </p>
              </motion.div>
            </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 48px oklch(0.62 0.2 200 / 0.12), inset 0 0 32px oklch(0.62 0.2 200 / 0.05)",
                }}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                    Step into a shared creative universe with builders from
                    every corner of the planet. Co-create, remix in real time,
                    and turn your ideas into something the world hasn't seen —
                    together.
                  </p>
                </div>
                <Link
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(0.65 0.22 200 / 0.5), oklch(0.7 0.2 180 / 0.4), transparent)",
            }}
          />
          <div
            className="absolute inset-x-0 bottom-0 h-px"
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(0.65 0.22 200 / 0.3), transparent)",
            }}
          />
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
                  Every app you create automatically connects to verified
                  real-time data sources — weather, maps, health APIs, and more.
                </p>
              </motion.div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto mb-10">
              {LIVE_DATA_SOURCES.map(
                ({ icon, title, description, glowColor, borderColor }, idx) => (
                  <motion.div
                    key={title}
            ...
            >
              <Link to="/live-data" data-ocid="landing.live_data_hub_button">
                <GlassButton variant="holographic" size="lg" className="gap-2">
                  <Globe className="h-4 w-4" />
        ...
        >
          ...
          <div className="container mx-auto px-4 lg:px-6 relative z-10">
            ...
            >
              ...
              >
                <div className="h-20 w-20 rounded-2xl bg-primary/20 border border-primary/30 flex items-center justify-center glow-pulse">
                  <Brain className="h-10 w-10 text-primary" />
                </div>
                <div>
                  <h2 className="font-display font-bold text-4xl lg:text-5xl mb-4 tracking-tight">
                  ...
                  <p className="text-muted-foreground max-w-xl mx-auto text-lg leading-relaxed">
                    Stop overthinking. Stop waiting. The only thing standing
                    between your idea and a real product is one prompt — and
                    you've got this.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link to="/dashboard" data-ocid="landing.cta_final_button">
                    <GlassButton
                      variant="holographic"
                      size="lg"
                ...
                <p className="text-xs text-muted-foreground">
                  Free forever. No card needed. Start earning XP in the next 60
                  seconds.
                </p>
              </motion.div>
            </GlassCard>
      ...
      {/* ── Footer ──────────────────────────────────────────────── */}
      <footer className="relative z-10 bg-muted/40 backdrop-blur-md border-t border-border/40 py-6">
        <div className="container mx-auto px-4 lg:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
