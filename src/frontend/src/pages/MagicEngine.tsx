...
type RevealStage = "wireframe" | "mockup" | "build-ready" | "done";
type TrendSourceKind = "country" | "category" | "interest";
...
interface AppIdea {
  ...
  attribution: string[];
  trendRegion?: string;
  trendAttribution?: TrendAttribution;
}
...
const DYNAMIC_TREND_SEEDS: DynamicSeed[] = [
  {
    ...
    trendRegion: "Japan 🇯🇵",
    description:
      "Personalized AI health advisor that adapts to your biometrics daily",
    rarity: "Legendary",
  },
  {
  ...
  },
  {
    ...
    trendRegion: "India 🇮🇳",
    description:
      "Master any skill with 5-minute daily lessons and spaced repetition",
    rarity: "Common",
  },
  {
    ...
    trendRegion: "Brazil 🇧🇷",
    description:
      "Discover and connect with unsung heroes making a difference nearby",
    rarity: "Common",
  },
  {
    ...
    trendRegion: "USA 🇺🇸",
    description:
      "Gamified habit tracker that builds streaks with social accountability",
    rarity: "Rare",
  },
  {
    ...
    description:
      "Speak your thoughts — AI organizes, summarizes, and reveals your patterns",
    rarity: "Legendary",
  },
  {
    ...
    trendRegion: "France 🇫🇷",
    description:
      "Weekly meal plans generated from your dietary goals, budget, and fridge",
    rarity: "Common",
  },
  {
    ...
    trendRegion: "UK 🇬🇧",
    description:
      "Hyper-local event discovery matching your mood, interests, and schedule",
    rarity: "Common",
  },
  {
    ...
    description:
      "AI companion for daily check-ins, mood tracking, and mental resilience",
    rarity: "Legendary",
  },
  {
    ...
    trendRegion: "USA 🇺🇸",
    description:
      "One-click monetization layer for any creator — tips, subscriptions, merch",
    rarity: "Rare",
  },
  {
    ...
    description:
      "Live AI conversation partner for language learning in real scenarios",
    rarity: "Rare",
  },
  {
    ...
    trendRegion: "Nigeria 🇳🇬",
    description:
      "Crowdsourced local maps where residents annotate their neighbourhood",
    rarity: "Common",
  },
];
...
const APP_IDEAS: AppIdea[] = [
  ...
  },
  {
    ...
    name: "ByteBarter",
    concept:
      "Micro-task marketplace — complete 5-min tasks for digital rewards",
    features: [
      "Task matching",
  ...
  },
  {
    ...
    name: "StarterKit AI",
    concept:
      "Instant co-founder match — AI pairs solo founders with complementary skills",
    features: [
      "Skill gap analysis",
      "Co-founder matching",
      "Equity calculator",
...
// ─── Trend Attribution Pool ───────────────────────────────────────────────────

const TREND_ATTRIBUTION_POOL: TrendAttribution[] = [
  {
...
const INTEREST_ATTRIBUTION: TrendAttribution = {
  label: "Based on Your Interests ⚡",
  reason: "Matched from your builder history, past ideas, and creator profile",
  kind: "interest",
};

function pickTrendAttribution(seed?: DynamicSeed): TrendAttribution {
  ...
  return TREND_ATTRIBUTION_POOL[
    Math.floor(Math.random() * TREND_ATTRIBUTION_POOL.length)
  ];
}

function seedToIdea(seed: DynamicSeed): AppIdea {
  return {
...
function pickRandomIdea(): AppIdea {
  const useSeed = Math.random() < 0.7;
  const roll = Math.random();
  if (useSeed) {
    let seedPool: DynamicSeed[];
    if (roll < 0.1)
...
function trendingToIdea(t: TrendingIdea): AppIdea {
    ...
    return (
      <span
        ...
        style={{
          ...
          boxShadow:
            "0 0 18px oklch(0.75 0.28 50 / 0.55), 0 0 6px oklch(0.75 0.28 50 / 0.3)",
...
function TransformationReveal({
  ...
  const [stage, setStage] = useState<RevealStage>("wireframe");
  const [dotCount, setDotCount] = useState(1);

  // Animated dots for Mystery Mode
  useEffect(() => {
    if (!isMystery) return;
  ...
  // Stage progression: wireframe → mockup → build-ready → done
  useEffect(() => {
    const t1 = setTimeout(() => setStage("mockup"), 500);
    const t2 = setTimeout(() => setStage("build-ready"), 1000);
    const t3 = setTimeout(() => {
      setStage("done");
      onComplete();
    }, 1500);
  ...
  const stageLabel = isMystery
    ? `Reality Materializing${".".repeat(dotCount)}`
    : stage === "wireframe"
      ? "Materializing..."
      : stage === "mockup"
        ? "Rendering..."
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="flex gap-2 mb-5">
          {(["wireframe", "mockup", "build-ready"] as const).map((s, i) => (
            <div
              key={s}
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, oklch(0.72 0.22 262 / 0.7), transparent)",
                      filter: "blur(2px)",
                    }}
                    animate={{ top: ["0%", "100%"] }}
                    transition={{
            ...
            {stage === "mockup" && (
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.12 0.02 262 / 0.8), oklch(0.14 0.02 280 / 0.8))",
              ...
              >
                    ...
                    style={{
                      background:
                        idea.rarity === "Legendary"
                          ? "oklch(0.75 0.28 50 / 0.4)"
                          : "oklch(0.72 0.22 262 / 0.4)",
                    }}
                  />
                </div>
                <div
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, oklch(0.72 0.22 262 / 0.5), oklch(0.75 0.28 50 / 0.4))",
                  }}
                />
              </motion.div>
            )}

            {/* Stage 3: Build-ready (rarity content emerges) */}
            {(stage === "build-ready" || stage === "done") && (
              <motion.div
                key="build-ready"
                ...
                style={{
                  ...
                  boxShadow:
                    idea.rarity === "Legendary"
                      ? "0 0 40px oklch(0.75 0.28 50 / 0.3)"
                      : "none",
                }}
              ...
              >
                ...
                <h3
                  ...
                  style={{
                    background:
                      idea.rarity === "Legendary"
                        ? "linear-gradient(135deg, oklch(0.85 0.3 50), oklch(0.75 0.28 50))"
                        : idea.rarity === "Rare"
                          ? "linear-gradient(135deg, oklch(0.82 0.22 280), oklch(0.72 0.22 262))"
                          : "linear-gradient(135deg, oklch(var(--foreground)), oklch(var(--muted-foreground)))",
                    backgroundClip: "text",
...
function LegendaryCinematicOverlay({ onDone }: { onDone: () => void }) {
  const [showText, setShowText] = useState(true);
  const [showBurst, setShowBurst] = useState(true);

  useEffect(() => {
    playLegendaryChime();
    const t1 = setTimeout(() => setShowBurst(false), 1000);
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-30 flex items-center justify-center overflow-hidden rounded-2xl">
      {/* Gold glow ring */}
      <motion.div
        className="absolute rounded-full"
        style={{
          ...
          boxShadow:
            "0 0 40px oklch(0.82 0.3 65 / 0.5), inset 0 0 30px oklch(0.82 0.3 65 / 0.1)",
        }}
      ...
      {/* Particle burst */}
      <AnimatePresence>
        {showBurst && <LegendaryParticleBurst key="burst" />}
      </AnimatePresence>
      {/* LEGENDARY holographic text */}
      <AnimatePresence>
        {showText && (
          <motion.div
            className="absolute"
          ...
          >
            <span
              ...
              style={{
                background:
                  "linear-gradient(90deg, oklch(0.85 0.3 50), oklch(0.95 0.15 70), oklch(0.82 0.32 40), oklch(0.92 0.25 65))",
...
// ─── Legendary Particles (ambient, inside modal card) ────────────────────────

const PARTICLE_CONFIGS = [0, 1, 2, 3, 4, 5, 6, 7] as const;

function LegendaryParticles() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-2xl">
      {PARTICLE_CONFIGS.map((i) => (
        <motion.div
          key={`particle-${i}`}
...
const BEHAVIOR_STATS: StatCounter[] = [
        ...
        {BEHAVIOR_STATS.map((stat) => (
          <div key={stat.label} className="flex flex-col items-center gap-0.5">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.85 0.2 262), oklch(0.72 0.22 262))",
                backgroundClip: "text",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
              {stat.icon} <CountUpNumber target={stat.target} duration={1200} />
              {stat.suffix}
            </div>
            <div
...
function IdeaModal({
  ...
  // For Common/Rare: play entry animation on mount (Legendary plays after cinematic)
  useEffect(() => {
    if (!showCinematic) {
      controls.start({
        scale: 1,
  ...
  // Spring scale-up for legendary after cinematic
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            idea.rarity === "Legendary"
              ? "0 0 60px oklch(0.75 0.28 50 / 0.25), 0 20px 40px oklch(0.08 0 0 / 0.6)"
              : idea.rarity === "Rare"
                ? "0 0 40px oklch(0.62 0.25 280 / 0.2), 0 20px 40px oklch(0.08 0 0 / 0.6)"
                : "0 20px 40px oklch(0.08 0 0 / 0.6)",
        }}
        ...
        transition={{ type: "spring", damping: 20, stiffness: 280 }}
      >
        {idea.rarity === "Legendary" && <LegendaryParticles />}
        ...
        {isMystery && (
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.72 0.22 262 / 0.04), oklch(0.62 0.25 280 / 0.06))",
        ...
        {/* Trend Attribution Banner */}
        {idea.trendAttribution && (
          <motion.div
          ...
          >
            <div
              ...
              style={{
                background:
                  idea.trendAttribution.kind === "interest"
                    ? "oklch(0.55 0.22 50 / 0.14)"
                    : idea.trendAttribution.kind === "country"
                      ? "oklch(0.55 0.2 142 / 0.14)"
                      : "oklch(0.72 0.22 262 / 0.14)",
            ...
            <div
              ...
              style={{
                background:
                  idea.trendAttribution.kind === "interest"
                    ? "oklch(0.55 0.22 50 / 0.07)"
                    : idea.trendAttribution.kind === "country"
                      ? "oklch(0.55 0.2 142 / 0.07)"
                      : "oklch(0.72 0.22 262 / 0.07)",
              }}
            >
              <p
        ...
        >
          <p
            ...
            style={{ color: "oklch(0.72 0.22 262)" }}
          >
            🧠 Powered by Smart Luck
          </p>
          <div className="flex flex-wrap gap-1.5">
            {idea.attribution.map((attr) => (
              <span
                key={attr}
                className="text-xs px-2 py-0.5 rounded-full"
                style={{
        ...
        <button
          ...
          onClick={() =>
            navigate({ to: "/builder/$id", params: { id: "magic-lucky" } })
          }
...
// ─── Mystery Loading Overlay ──────────────────────────────────────────────────

function MysteryLoader({ onDone }: { onDone: () => void }) {
  return (
    <motion.div
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.72 0.22 262 / 0.3) 0%, transparent 70%)",
      ...
      <motion.p
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.72 0.22 262), oklch(0.62 0.25 280))",
          backgroundClip: "text",
          WebkitBackgroundClip: "text",
          WebkitTextFillColor: "transparent",
        }}
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "conic-gradient(from 0deg, oklch(0.72 0.22 262), oklch(0.62 0.25 280), oklch(0.75 0.28 50), oklch(0.72 0.22 262))",
          padding: "2px",
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 35% 35%, oklch(0.75 0.22 262 / 0.9), oklch(0.35 0.2 280 / 0.8) 60%, oklch(0.15 0.1 280) 100%)",
          boxShadow:
            "inset 0 0 20px oklch(0.72 0.22 262 / 0.3), 0 0 30px oklch(0.72 0.22 262 / 0.4)",
        }}
...
// ─── Trending Card (with pulsing neon glow border) ────────────────────────────

interface TrendingCardProps {
  idea: TrendingIdea;
  index: number;
  onRemix: (idea: TrendingIdea) => void;
}

function TrendingCard({ idea, index, onRemix }: TrendingCardProps) {
  const rarityGlowClass =
    idea.rarity === "Legendary"
      ? "trending-glow-legendary"
      : idea.rarity === "Rare"
        ? "trending-glow-rare"
        : "trending-glow-common";

  const borderColor =
    idea.rarity === "Legendary"
      ? "oklch(0.75 0.28 50 / 0.65)"
      : idea.rarity === "Rare"
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-2xl">{idea.flag}</span>
            <span
              className="text-xs font-medium"
              style={{ color: "oklch(var(--muted-foreground))" }}
            >
...
export default function MagicEngine() {
  const [modalIdea, setModalIdea] = useState<AppIdea | null>(null);
  const [isMystery, setIsMystery] = useState(false);
  const [mysteryLoading, setMysteryLoading] = useState(false);
  const [showReveal, setShowReveal] = useState(false);
  const [revealIdea, setRevealIdea] = useState<AppIdea | null>(null);
  const [revealIsMystery, setRevealIsMystery] = useState(false);
  ...
  const onMysteryRevealed = useCallback(() => {
  ...
  const onRemix = useCallback((t: TrendingIdea) => {
    setIsMystery(false);
  ...
  return (
    ...
    >
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.72 0.22 262 / 0.6) 0%, transparent 70%)",
            }}
          />
          <div
        ...
        >
          ...
          >
            ...
            <span>AI-powered luck engine</span>
          </motion.div>
          ...
          <motion.h1
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.95 0 0) 20%, oklch(0.72 0.22 262) 50%, oklch(0.75 0.28 50) 80%)",
              backgroundClip: "text",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
          ...
          >
            Our AI analyzes global trends, your creator history, and viral
            patterns to generate ideas that feel like luck — but are actually
            intelligent design.
          </motion.p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2
              ...
              style={{ color: "oklch(var(--foreground))" }}
            >
              Smart Luck, Not Random 🧠
            </h2>
            <p style={{ color: "oklch(var(--muted-foreground))" }}>
              Every idea is crafted by intelligence disguised as fortune
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6">
            {SMART_LUCK_CARDS.map((card, i) => (
              <motion.div
                key={card.title}
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p style={{ color: "oklch(var(--muted-foreground))" }}>
              Ideas trending right now around the world — remix any of them
              instantly
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "oklch(var(--muted-foreground))" }}
            >
              Every creation is unique. Some ideas are once-in-a-generation.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {RARITY_INFO.map((r, i) => (
              <motion.div
                ...
                style={{ boxShadow: r.glow || undefined }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <motion.h2
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.95 0 0), oklch(0.72 0.22 262), oklch(0.75 0.28 50))",
              backgroundClip: "text",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
            ...
            viewport={{ once: true }}
          >
            Your next big idea is one tap away
          </motion.h2>
          <motion.p
          ...
          >
            Create with AI. Discover with luck.
          </motion.p>
          <motion.div
      ...
      <AnimatePresence>
        {mysteryLoading && (
          <MysteryLoader key="mystery-loader" onDone={onMysteryRevealed} />
        )}
      </AnimatePresence>

      <AnimatePresence>
        {showReveal && revealIdea && (
