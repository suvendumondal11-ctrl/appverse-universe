...
const SHOWCASE_APPS: ShowcaseApp[] = [
  {
    ...
    name: "Doctor Finder",
    description:
      "Live doctor availability, booking slots, and real-time wait times",
  ...
  },
  {
    ...
    name: "City Navigator",
    description:
      "Real-time traffic, public transit updates, and live crowd data",
  ...
  },
  {
    ...
    name: "Learn & Grow",
    description:
      "Fresh course content, live tutors, and updated learning paths",
  ...
  },
  {
    ...
    name: "WeatherSphere",
    description:
      "Minute-by-minute conditions, air quality, and severe weather alerts",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 260,
          background:
            "radial-gradient(circle, oklch(0.65 0.22 220 / 0.15) 0%, transparent 70%)",
      ...
      <div
        ...
        style={{
          ...
          height: 120,
          background:
            "radial-gradient(circle at 35% 35%, oklch(0.72 0.2 220), oklch(0.42 0.22 260))",
          boxShadow:
            "0 0 40px oklch(0.62 0.2 220 / 0.5), inset 0 0 20px oklch(0.9 0.05 220 / 0.2)",
        }}
      >
        {/* Latitude lines as SVG */}
        <svg
          width="120"
          height="120"
          viewBox="0 0 120 120"
      ...
      {/* Connecting lines to globe center */}
      <svg
        className="absolute inset-0"
        width="260"
        height="260"
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <span
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.52 0.2 262), oklch(0.62 0.25 200))",
          backgroundClip: "text",
...
function LiveBadge({
  badge,
  color,
}: { badge: DataSource["badge"]; color: string }) {
  const icons = { Live: "●", Updated: "↻", Verified: "✓" } as const;
  return (
    <span
...
export default function LiveData() {
  const [activeApp, setActiveApp] = useState<string>("fitness");
  const [prevApp, setPrevApp] = useState<string>("fitness");
  ...
  const showcaseAccentMap: Record<string, string> = {
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(160deg, oklch(0.97 0.015 220 / 1) 0%, oklch(0.96 0.02 262 / 1) 60%, oklch(0.97 0.008 280 / 1) 100%)",
          minHeight: "90vh",
        }}
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, oklch(0.62 0.18 220 / 0.06) 1px, transparent 1px)",
        ...
        <div
          ...
          style={{
            ...
            height: 400,
            background:
              "radial-gradient(ellipse, oklch(0.72 0.2 220 / 0.12) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-3xl mx-auto">
          ...
          <h1
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.15 0.02 262) 0%, oklch(0.38 0.2 220) 50%, oklch(0.52 0.2 262) 100%)",
              backgroundClip: "text",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link to="/dashboard" data-ocid="live_data.hero.primary_button">
              <Button
                size="lg"
                className="text-base font-semibold px-7 py-3 rounded-xl"
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.52 0.2 220), oklch(0.52 0.2 262))",
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-black font-display mt-3 text-foreground">
              From idea to live app in 3 steps
            </h2>
            <p className="text-muted-foreground mt-2 text-base max-w-md mx-auto">
              No APIs to configure. No backend to manage. Just describe what you
              want.
            </p>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black font-display mt-3 text-foreground">
              Every app type. Real data sources.
            </h2>
            <p className="text-muted-foreground mt-2 max-w-md mx-auto">
              Select an app type to see which live data sources power it.
            </p>
          </div>
          ...
          {/* Data source cards */}
          <div
            key={`${activeApp}-${animKey}`}
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4"
            data-ocid="live_data.explorer.sources_list"
          >
            {activeAppData.sources.map((src, i) => (
              <div
                key={`${prevApp}-${src.name}-${i}`}
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="live-dot mt-1.5" />
                </div>
                <p className="text-sm font-semibold text-foreground leading-snug">
                  {src.name}
                </p>
                <LiveBadge badge={src.badge} color={src.badgeColor} />
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-black font-display mt-3 text-foreground">
              Real apps. Live data. Right now.
            </h2>
            <p className="text-muted-foreground mt-2 max-w-md mx-auto">
              These are just examples — you can build thousands more in minutes.
            </p>
          </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.52 0.2 220 / 0.08), oklch(0.52 0.2 262 / 0.06))",
      ...
      >
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-6">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.52 0.2 220 / 0.15), oklch(0.52 0.2 262 / 0.1))",
          ...
          <h2 className="text-3xl sm:text-4xl font-black font-display text-foreground">
            Ready to connect your app to the world?
          </h2>
          <p className="text-muted-foreground text-base max-w-sm">
            Join <strong className="text-foreground">50,000+ creators</strong>{" "}
            already building with live global data.
          </p>
          <Link to="/dashboard" data-ocid="live_data.cta.primary_button">
            <Button
              size="lg"
